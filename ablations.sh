...
# for i in {3..3}
# do
# 	echo "Recovery RL PETS Recovery 500 demos Run $i"
# 	python -m main --cuda --env-name shelf_long_env --task_demos --tau 0.0002 --replay_size 100000 --num_task_transitions 500 --use_recovery --recovery_policy_update_freq 20 --gamma_safe 0.85 --eps_safe 0.35 --use_qvalue --num_eps 4000 --num_constraint_transitions 100 --logdir shelf_long_env --logdir_suffix recovery_0.85_0.35_500 --pos_fraction 0.3 --seed $i
# done
...
# do
# 	echo "Recovery RL PETS Recovery Run $i"
# 	python -m main --cuda --env-name shelf_long_env --task_demos --tau 0.0002 --replay_size 100000 --num_task_transitions 1000 --use_recovery --recovery_policy_update_freq 20 --gamma_safe 0.75 --eps_safe 0.45 --use_qvalue --num_eps 4000 --logdir shelf_long_env --logdir_suffix recovery_0.75_0.45 --pos_fraction 0.3 --seed $i
# done

# for i in {1..3}
# do
# 	echo "Recovery RL PETS Recovery Run $i"
# 	python -m main --cuda --env-name shelf_long_env --task_demos --tau 0.0002 --replay_size 100000 --num_task_transitions 1000 --use_recovery --recovery_policy_update_freq 20 --gamma_safe 0.75 --eps_safe 0.55 --use_qvalue --num_eps 4000 --logdir shelf_long_env --logdir_suffix recovery_0.75_0.55 --pos_fraction 0.3 --seed $i
# done
...
# do
# 	echo "Recovery RL PETS Recovery Run $i"
# 	python -m main --cuda --env-name shelf_long_env --task_demos --tau 0.0002 --replay_size 100000 --num_task_transitions 1000 --use_recovery --recovery_policy_update_freq 20 --gamma_safe 0.95 --eps_safe 0.15 --use_qvalue --num_eps 4000 --logdir shelf_long_env --logdir_suffix recovery_0.95_0.15 --pos_fraction 0.3 --seed $i
# done

# for i in {1..3}
# do
# 	echo "Recovery RL PETS Recovery Run $i"
# 	python -m main --cuda --env-name shelf_long_env --task_demos --tau 0.0002 --replay_size 100000 --num_task_transitions 1000 --use_recovery --recovery_policy_update_freq 20 --gamma_safe 0.95 --eps_safe 0.25 --use_qvalue --num_eps 4000 --logdir shelf_long_env --logdir_suffix recovery_0.95_0.25 --pos_fraction 0.3 --seed $i
# done

# for i in {1..3}
# do
# 	echo "Recovery RL PETS Recovery Run $i"
# 	python -m main --cuda --env-name shelf_long_env --task_demos --tau 0.0002 --replay_size 100000 --num_task_transitions 1000 --use_recovery --recovery_policy_update_freq 20 --gamma_safe 0.95 --eps_safe 0.35 --use_qvalue --num_eps 4000 --logdir shelf_long_env --logdir_suffix recovery_0.95_0.35 --pos_fraction 0.3 --seed $i
# done

# for i in {1..3}
# do
# 	echo "Recovery RL PETS Recovery Run $i"
# 	python -m main --cuda --env-name shelf_long_env --task_demos --tau 0.0002 --replay_size 100000 --num_task_transitions 1000 --use_recovery --recovery_policy_update_freq 20 --gamma_safe 0.95 --eps_safe 0.45 --use_qvalue --num_eps 4000 --logdir shelf_long_env --logdir_suffix recovery_0.95_0.45 --pos_fraction 0.3 --seed $i
# done

# for i in {1..3}
# do
# 	echo "Recovery RL PETS Recovery Run $i"
# 	python -m main --cuda --env-name shelf_long_env --task_demos --tau 0.0002 --replay_size 100000 --num_task_transitions 1000 --use_recovery --recovery_policy_update_freq 20 --gamma_safe 0.95 --eps_safe 0.55 --use_qvalue --num_eps 4000 --logdir shelf_long_env --logdir_suffix recovery_0.95_0.55 --pos_fraction 0.3 --seed $i
# done
